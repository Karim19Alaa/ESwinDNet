# -------------------------------------------------------------------------------------------------------------------------------------
# Following Based on the implementaion of Bio-Diffusion (https://github.com/BioinfoMachineLearning/bio-diffusion):
# -------------------------------------------------------------------------------------------------------------------------------------
...
class EMA(Callback):
    ...
    def on_train_start(self, trainer: "pl.Trainer", pl_module: "pl.LightningModule") -> None:
        logger.info("Creating EMA weights copy.")
    ...
    def on_load_checkpoint(
        ...
        if trainer.ckpt_path and checkpoint_callback is not None:
            ...
            if os.path.exists(ema_path):
                ...
                del ema_state_dict
                logger.info("EMA weights have been loaded successfully. Continuing training with saved EMA weights.")
            else:
                warnings.warn(
