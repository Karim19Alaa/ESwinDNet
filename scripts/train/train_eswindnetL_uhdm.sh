...
name=001_train_WSESwinDNetL_Demoiring_UHDM_from_scratch \
model=eswindnet \
model.net.depth=6 \
...
data.opt.val.dataset.dataroot="datasets/uhdm/train" \
data.opt.test.dataset.dataroot="datasets/uhdm/train" \
...
trainer.trainer_args.max_steps=337500 